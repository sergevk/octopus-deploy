...
#      'C:\Program Files\Octopus Deploy\Tentacle'
      'E:\Program Files\Octopus\Tentacle'
    end

    def tentacle_installer_options
#      '/qn /norestart'
#      '/qn /norestart INSTALLLOCATION="E:\\Program Files\\Octopus\\Tentacle"'
      "/qn /norestart INSTALLLOCATION=\"#{tentacle_install_location}\""
    end   
